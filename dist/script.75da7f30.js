...
var Workout = /*#__PURE__*/function () {
  function Workout(coords, distance, duration) {
    ...
    _defineProperty(this, "save", true);
...
var Runnning = /*#__PURE__*/function (_Workout) {
  _inherits(Runnning, _Workout);

  var _super = _createSuper(Runnning);

  function Runnning(coords, distance, duration, cadence) {
    var _this;

    _classCallCheck(this, Runnning);

    _this = _super.call(this, coords, distance, duration);

    _defineProperty(_assertThisInitialized(_this), "type", 'running');

    _this.cadence = cadence; //this.type = 'running'
...
var Cycling = /*#__PURE__*/function (_Workout2) {
  ...
  function Cycling(coords, distance, duration, elevationGain, speed) {
    var _this2;
...
var btnReset = document.querySelector('.btn__reset'); // ---------------------- App Class - contains all the functionality of our App
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function _select() {
      ...
      var index = _classPrivateFieldGet(this, _workouts).findIndex(function (el) {
    ...
    value: function _loadMap(position) {
      ...
      _classPrivateFieldGet(this, _workouts).forEach(function (work) {
        _this3.renderWorkoutMarker(work);
      });
    }
  }, {
    key: "_showForm",
    ...
    value: function _hideForm() {
      ...
      }, 1000); // to focus on distance input
    ...
    value: function _newWorkout(e) {
      ...
      var allInputsPositive = function allInputsPositive() {
      ...
      if (type === 'running') {
        ...
        if (!validInputs(distance, duration, cadence) || !allInputsPositive(distance, duration, cadence)) return alert('Inputs have to be positive numbers!');
        workout = new Runnning([lat, lng], distance, duration, cadence);
      }

      if (type === 'cycling') {
        var elevation = +inputElevation.value;
        if (!validInputs(distance, duration, elevation) || !allInputsPositive(distance, duration)) return alert('Inputs have to be positive numbers!');
    ...
    key: "renderWorkoutMarker",
    value: function renderWorkoutMarker(workout) {
      ...
      })).setPopupContent("".concat(workout.type === 'running' ? '🏃‍♂' : '🚴‍♀️', " ").concat(workout.description)).openPopup();
    }
  }, {
    key: "_renderWorkout",
    ...
    value: function _moveToPopup(e) {
      var workoutEl = e.target.closest('.workout'); // console.log(workoutEl);
      // Guard Clause
...
var app = new App();
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
